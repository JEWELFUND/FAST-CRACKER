...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 JEWEL FUNDS 🔥].  ║

\x1b[0;33m║       #TOOL AUTHOR [JEWEL FUNDS] MAFIA PATHAN. ║
...
\x1b[0;33m║#YOUTUBE : JEWEL FUNDS😐.  ║

\x1b[0;33m║#FACEBOOK : NAME [JEWEL FUNDS  ].       ║

\x1b[0;33m║#GITHUB : https://github.com/JEWELFUND/FAST-CRACKER.   ║

\x1b[0;33m║#WHATSAPP : 09055012862.                   ║
...
def menu():
	...
	elif jewel == "1" or JEWEL == "01":

		publik()

		method()

	elif jewel == "2" or JEWEL == "02":

		follower()

		method()

	elif jewel == "3" or  JEWEL == "03":

		massal()

		method()

	elif Umair == "4" or JEWEL == "04":
